...
export const MODULES = [
  { key: 'dashboard', label: 'Hôm nay', path: '/dashboard', title: 'Hôm nay', sidebarVisible: false, permissionManaged: false },
  ...
  { key: 'dailyMonitoring', label: 'Theo dõi ngày', path: '/daily-monitoring', title: 'Theo dõi ngày', sidebarVisible: true, permissionManaged: true },
  { key: 'medications', label: 'Thuốc', path: '/medications', title: 'Thuốc', sidebarVisible: true, permissionManaged: true },
  { key: 'procedures', label: 'Thủ thuật', path: '/procedures', title: 'Thủ thuật y tế', sidebarVisible: true, permissionManaged: true },
  { key: 'weightTracking', label: 'Theo dõi cân nặng', path: '/weight-tracking', title: 'Theo dõi cân nặng', sidebarVisible: false, permissionManaged: true },
