...
export const PrintWeightForm = ({ month, residents, records }: PrintWeightFormProps) => {
  ...
  return (
    <div className="p-8 bg-white text-black print:block hidden font-serif">
      <div className="flex items-start justify-between gap-4 mb-6 border-b border-black pb-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold uppercase">{branding.name}</h1>
            <p className="text-xs">Địa chỉ: {branding.address}</p>
            <p className="text-xs">Hotline: {branding.phone}</p>
          </div>
        </div>
        <div className="text-center">
          <h2 className="text-2xl font-bold uppercase">Bảng Theo Dõi Cân Nặng</h2>
