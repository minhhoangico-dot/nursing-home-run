...
export const PrescriptionList = ({ user, resident, onUpdate, readOnly = false }: { user: User, resident: Resident, onUpdate: (r: Resident) => void, readOnly?: boolean }) => {
    ...
    return (
        <div className="space-y-8">
            ...
            {showMedicineManager && !readOnly && (
                <MedicineManager onClose={() => setShowMedicineManager(false)} readOnly={readOnly} />
            )}
