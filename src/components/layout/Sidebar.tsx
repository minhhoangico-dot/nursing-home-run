...
export const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { id: 'weight', label: 'Cân nặng', path: '/weight-tracking', icon: Scale, roles: ['ADMIN', 'DOCTOR', 'SUPERVISOR', 'NURSE'] },
    { id: 'activities', label: 'Hoạt động', path: '/activities', icon: Smile, roles: ['ADMIN', 'SUPERVISOR', 'NURSE', 'CAREGIVER'] },
    { id: 'handover', label: 'Sổ giao ban', path: '/handover', icon: BookOpen, roles: ['ADMIN', 'DOCTOR', 'SUPERVISOR', 'NURSE'] },
    { id: 'schedule', label: 'Lịch trực', path: '/schedule', icon: CalendarDays, roles: ['ADMIN', 'DOCTOR', 'SUPERVISOR', 'NURSE', 'CAREGIVER'] },
    { id: 'visitors', label: 'Khách thăm', path: '/visitors', icon: UserCheck, roles: ['ADMIN', 'DOCTOR', 'SUPERVISOR', 'NURSE', 'CAREGIVER'] },
    { id: 'medication', label: 'Cấp phát thuốc', path: '/medication', icon: Pill, roles: ['ADMIN', 'DOCTOR', 'NURSE', 'SUPERVISOR'] },
