        ...
        try {
            ...
            set((state) => ({
                records: (data || []).map((d: any) => ({
                    ...
                    gastricTubeCount: d.gastric_tube_count,
                    urinaryCatheterCount: d.urinary_catheter_count,
                    bladderWashCount: d.bladder_wash_count,
                    bloodSugarTestCount: d.blood_sugar_test_count,
                    bloodPressureCount: d.blood_pressure_count,
                    oxygenTherapyCount: d.oxygen_therapy_count,
    ...
    upsertRecord: async (record) => {
        ...
        try {
            const dbRecord = {
                ...
                gastric_tube_count: record.gastricTubeCount,
                urinary_catheter_count: record.urinaryCatheterCount,
                bladder_wash_count: record.bladderWashCount,
                blood_sugar_test_count: record.bloodSugarTestCount,
                blood_pressure_count: record.bloodPressureCount,
